...
const getUserChannelProfile = asyncHandlerPromiseVersion(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, channel, "Channel is present"));
});

const getUserWatchHistory = asyncHandlerPromiseVersion(async (req, res) => {
